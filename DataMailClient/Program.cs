...
namespace DataMailClient
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var mail1 = JSONService.ParseFromJSON(new string(@"Mails/Mail1.json")); //vérification de la conversion en object mail
            var json1 = JSONService.SerializeToJSON(mail1); //vérification du fonctionnement de la sérialisation
            debug.Add("Mail1");
            debug.AddRange(JSONService.ValidatingJSON(schema, @"Mails/Mail1.json")); //vérification de la conformité
